...
import { Delete, Edit, Add as AddIcon, AccountBalanceWallet, Exposure, Done } from "@material-ui/icons";
                            ...
                            <div style={modalStyle} className={classes.paper}>
                                ...
                                <p id="simple-modal-description">
                                    {itemSelected && (
                                        ...
                                        {/* <img src={process.env.REACT_APP_UPLOADS + itemSelected} alt={itemSelected} className={classes.photo}/> */}
                                        </>
                                    )}
                        ...
                        <Card>
                            <CardContent>
                                <FormSearchDate
                                    ...
                                    urlDownload={process.env.REACT_APP_API + "schedule_mtc/download"}
                                /> 
