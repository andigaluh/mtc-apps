...
const Equipment = () => {
    ...
    const retrieveItem = () => {
        ...
        equipmentService.getAll(params).then(
            (response) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            cell: (row) => {
                return (
                    <React.Fragment>
                        <Link to={"/equipment/form/" + row.id} title="Detail">
                        ...
                        <IconButton color="primary" title="Delete" aria-label="Delete" onClick={() => {
                            ...
                            if (r == true) {
                                equipmentService.remove(row.id)
                                    .then((response) => {
                                        setOpen(true);
        ...
        <Container className={classes.container} maxWidth="xl">
            <SparepartsContext.Provider value={value}>
                ...
                {!user.roles.includes("ROLE_SUPERVISOR") ? (
                    ...
                    <React.Fragment>
                        <Typography variant="h4" className={classes.title}>Equipment</Typography>
                        <Card>
                            <CardContent>
                                <FormSearch
                                    labelTitle="Equipment Name"
                                    ...
                                    urlDownload={process.env.REACT_APP_API + "equipment/download"}
                                />
