...
import schedule_mtcService from "../services/scheduleMtc_excel.service"
...
const FormScheduleMtcExcel = () => {
    ...
    return (
        <Container className={classes.container}>
            ...
            {/* {((!user.roles.includes("ROLE_ADMIN")) || (!user.roles.includes("ROLE_SUPERVISOR"))) ? (
                                        ...
                                        <Grid container spacing={2}>
                                            <Grid item xs={12}>
                                                <Typography variant="body2">Please use this xls template file before upload : &nbsp;
                                                    <a href={`${process.env.REACT_APP_API}schedule_mtc/download_template`} target="_blank" className={classes.link}>
                                                        <Button variant="contained" className={classes.buttonContainer} >
                                                            <CloudDownload className={classes.button} /> schedule-mtc_template.xlsx
                                                        </Button>
                                                    </a>
                                                </Typography>
                                            </Grid>
