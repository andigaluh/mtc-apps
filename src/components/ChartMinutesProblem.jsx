...
const ChartMinutesProblem = () => {
    ...
    const retrieveTotalMinutesProblem = () => {
        dashboardService.getTotalMinutesProblem().then(
            (response) => {
    ...
    return (
        <>
            <Typography variant="h6">Total Minutes Problem Machine</Typography>
            <Paper>
...
export default ChartMinutesProblem;