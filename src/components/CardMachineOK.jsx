...
const CardMachineOK = () => {
    ...
    return (
        <>
            <Typography variant="h6">Machine Check Status OK</Typography>
            <Paper>
                <div className={classes.wrapperResult}>
                    <img src={process.env.REACT_APP_UPLOADS + 'icons/icon-machine-1.png'} width={80} height={80} />
                    <div className={classes.result}>
                        <Typography size="medium" variant="body1">Machine Check OK</Typography>
                        <Typography size="large" variant="h2" className={classes.fontOK}>{machineOK.total_check}</Typography>
                ...
                <div className={classes.wrapperCompare}>
                    <div className={classes.compare}>
                        <Typography variant="caption">{machineOK.previous_month}{" "}{machineOK.year}</Typography>
                        <Typography variant="subtitle2">{machineOK.previous_total_check}</Typography>
                    </div>
                    <div className={classes.compare}>
                        <Typography variant="caption">{machineOK.month}{" "}{machineOK.year}</Typography>
                        <Typography variant="subtitle2">{machineOK.total_check}</Typography>
                    </div>
                    <div className={classes.compare}>
                        <Typography variant="caption">Diff</Typography>
                        <Typography variant="subtitle2">{machineOK.diff}</Typography>
                    </div>
                </div>
